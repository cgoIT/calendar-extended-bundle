...
// $GLOBALS['TL_LANG']['tl_module']['showRecurrences'] = ['Verkürzte Darstellung
// (Wiederholungen)', 'Events nur einmal anzeigen, auch wenn wiederholt werden.
// Template muss angepasst werden.'];
...
// $GLOBALS['TL_LANG']['tl_module']['cal_holiday'] = ['Ferienkalender', 'Bitte
// wählen Sie einen oder mehrere Kalender für die Ferien und Feiertage.'];
$GLOBALS['TL_LANG']['tl_module']['hide_holiday'] = ['Ferien ausblenden', 'Ferien und Feiertage nicht anzeigen.'];
// $GLOBALS['TL_LANG']['tl_module']['cal_calendar_ext'] = ['Kalender', 'Bitte
// wählen Sie einen oder mehrere Kalender.'];
...
// $GLOBALS['TL_LANG']['tl_module']['pubTimeRecurrences'] = ['Uhrzeit bei
// Wiederholungen berücksichtigen', 'Wiederholungen werden nur angezeigt, wenn
// die Zeit des Events innerhalb der Uhrzeit von "Anzeigen von/bis" liegt.'];
// $GLOBALS['TL_LANG']['tl_module']['displayDuration'] = ['Anzeigedauer der
// Events', 'Anzeigedauer der Events wird begrenzt. Bitte "strtotime" Syntax (+7
// days, +2 weeks) verwenden.']; $GLOBALS['TL_LANG']['tl_module']['hide_started']
// = ['Laufende Events nicht anzeigen', 'Events, die bereits gestartet sind,
// werden nicht mehr angezeigt.'];
// $GLOBALS['TL_LANG']['tl_module']['cal_format_ext'] = ['Anzeigeformat
// (erweitert strtotime)', 'Standard Anzeigeformat wird ignoriert, wenn gesetzt.
// Bitte "strtotime" Syntax (+7 days, +2 weeks) verwenden. +2 days => aktueller
// Tag + 2 Tage. Kann nicht mit (erweitert Zeitraum) verwendet werden.'];
// $GLOBALS['TL_LANG']['tl_module']['range_date'] = ['Anzeigeformat (erweitert
// Zeitraum)', 'Standard Anzeigeformat wird ignoriert, wenn gesetzt. Hier können
// die Events auf ein Start- und End-Datum eingegrenzt werden. Kann nicht mit
// (erweitert strtotime) verwendet werden.'];
// $GLOBALS['TL_LANG']['tl_module']['range_from'] = ['Datum von', 'Start-Datum
// der Events.']; $GLOBALS['TL_LANG']['tl_module']['range_to'] = ['Datum bis',
// 'End-Datum der Events.'];
